...
/**
 * This is main interface (and only) of IItem Renderer API. This allows for super-ultra-hyper dynamic item rendering and
 * <u>GL calls</u>. It also has methods for better overlay rendering. <b>It is <u>NOT</u> required to use BOTH!!!</b>
 * <br>
 * Implement this (you can use anonymous classes) and register instance with
 * {@link IItemRendererAPI#registerIItemRenderer(net.minecraft.item.Item, IItemRenderer)} to begin using dynamic
 * rendering.
 * <br>
 * <br>
 * Interface consists of 2 parts, 2 methods each (pre and post): item rendering and item GUI overlay rendering. Item
 * rendering is for item stack rendering and allows to do things like GL calls. GUI overlay is to change overlay
 * displayed in GUI, like adding second durability bar.
 * <br>
...
public interface IItemRenderer {
     ...
     * @param type       {@link TransformType} that will be/was used to transform model, if it is
     *                   {@link IPerspectiveAwareModel}
     * @return <b>TRUE</b> if rendering should proceed and model should be rendered. <b>FALSE</b> if rendering should be
     *         cancelled.
     */
    ...
    /**
     * Called before {@link ItemStack}'s GUI overlay is being rendered. You can cancel rendering by returning
     * <b>FALSE</b>.
     * 
     ...
     * @return <b>TRUE</b> if rendering should proceed and default overlay should be rendered. <b>FALSE</b> if rendering
     *         should be cancelled.
     */
